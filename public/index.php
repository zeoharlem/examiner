...
//require '../app/library/xlsimport/php-excel-reader/excel_reader2_helper.php';
//require '../app/library/xlsimport/SpreadsheetReader_XLS.php';
...
try{
    ...
    $di->set('dispatcher', function() use ($di){
        ...
        $eventsManager->attach('dispatch', LoggersPlugin::getLoggerInst());
        $eventsManager->attach('dispatch', ExceptionsPlugin::getExceptionInst());
