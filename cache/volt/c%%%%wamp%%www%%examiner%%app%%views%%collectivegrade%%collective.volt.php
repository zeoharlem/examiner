...
<section id="main-content">
    ...
    <div align="center" style="padding:30px;"><h2>DOMINICAN INSTITUTE IBADAN</h2>
        <h3>THE DEPARTMENT OF <?= Phalcon\Text::upper($this->request->getPost('department')) ?></h3>
        <strong>BROADSHEET FOR SEMESTER <?php echo $this->request->getPost('semester'); ?> <?= $this->request->getPost('session') ?>[<?= $this->request->getPost('level') ?>]</strong>
    </div>
    <style type="text/css">
  ...
  <!--<thead>
    <tr>
     ...
     <?php foreach ($regCourses as $keys => $values) { ?>
      <th class="rotates small text-center"><div><?= ucwords($values['title']) ?></div></th>
      <?php } ?>
      <th colspan="15"></th>
  ...
  <tbody>
    <tr>
      ...
      <td></td>
      <?php foreach ($regCourses as $keys => $values) { ?>
      <td class="text-center small" style="border:1px solid #aaa;"><?= Phalcon\Text::upper($values['code']) ?></td>
     <?php } ?>
    ...
    <tr>
      ...
      <?php $arraySet = ['matric' => $values['matric'], 'course' => $rValues['code']]; ?>
      ...
      <td class="text-center" style="border:1px solid #aaa;"><?php echo @$gradePointer->__getTotalUnitPass()/2; ?></td>
      <td class="text-center" style="border:1px solid #aaa;"><?php echo @$gradePointer->__getTotalUnitFail()/2; ?></td>
      <td class="text-center" style="border:1px solid #aaa;"><?php echo @$gradePointer->__getTotalGrade()/2; ?></td>
      <td class="text-center" style="border:1px solid #aaa;"><?php echo number_format(@$gradePointer->__weightedGradeAvr()/2, 2); ?></td>
      ...
      <?php @$gradePointer->__clearSetArray(); ?>
        <?php $typeArray = array('matric'=>$values['matric'],'semester'=>$values['semester'],'level'=>$values['level']); ?>
