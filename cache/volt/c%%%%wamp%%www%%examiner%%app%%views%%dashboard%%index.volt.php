...
<section id="main-content">
    ...
    <section class="panel">
        <header class="panel-heading">
            <strong><i class="fa fa-edit"></i> &nbsp; <a href="<?php echo $this->url->get('course/'); ?>" style="text-transform: capitalize">Courses</a></strong>
    ...
    <section class="panel">
        <header class="panel-heading">
            <strong><i class="fa fa-hdd-o"></i> &nbsp; <a href="<?php echo $this->url->get('packages/'); ?>" style="text-transform: capitalize">Session Packages</a></strong>
        <span class="tools pull-right">
            <a href="javascript:;" class="fa fa-chevron-up"></a>
            <a href="javascript:;" class="fa fa-times"></a>
        </span>
    ...
    <section class="panel">
        <header class="panel-heading">
            <strong><i class="fa fa-user-plus"></i> &nbsp; <a href="<?php echo $this->url->get('students/'); ?>" style="text-transform: capitalize">Course Registration</a></strong>
        <span class="tools pull-right">
            <a href="javascript:;" class="fa fa-chevron-up"></a>
            <a href="javascript:;" class="fa fa-times"></a>
        </span>
    ...
    <section class="panel">
        <header class="panel-heading">
            <strong><i class="fa fa-magnet"></i> &nbsp; <a href="<?php echo $this->url->get('matrics/'); ?>" style="text-transform: capitalize">Upload Matric Numbers</a></strong>
        <span class="tools pull-right">
            <a href="javascript:;" class="fa fa-chevron-up"></a>
            <a href="javascript:;" class="fa fa-times"></a>
        </span>
    ...
    <section class="panel">
        <header class="panel-heading">
            <strong><i class="fa fa-plus"></i> &nbsp; <a href="<?php echo $this->url->get('collectivegrade/'); ?>" style="text-transform: capitalize">Generate BroadSheet</a></strong>
        <span class="tools pull-right">
            <a href="javascript:;" class="fa fa-chevron-up"></a>
            <a href="javascript:;" class="fa fa-times"></a>
        </span>
    ...
    <section class="panel">
        <header class="panel-heading">
            <strong><i class="fa fa-keyboard-o"></i> &nbsp; <a href="<?php echo $this->url->get('course/department'); ?>" style="text-transform: capitalize">Department | Faculty</a></strong>
        <span class="tools pull-right">
            <a href="javascript:;" class="fa fa-chevron-up"></a>
            <a href="javascript:;" class="fa fa-times"></a>
        </span>
    ...
    <section class="panel">
        <header class="panel-heading">
            <strong><i class="fa fa-th-large"></i> &nbsp; <a href="<?php echo $this->url->get('results/'); ?>" style="text-transform: capitalize">Results</a></strong>
        <span class="tools pull-right">
            <a href="javascript:;" class="fa fa-chevron-up"></a>
            <a href="javascript:;" class="fa fa-times"></a>
        </span>
    ...
    <section class="panel">
        <header class="panel-heading">
            <strong><i class="fa fa-group"></i> &nbsp; <a href="<?php echo $this->url->get('lecturer/'); ?>" style="text-transform: capitalize">Lecturer</a></strong>
        <span class="tools pull-right">
            <a href="javascript:;" class="fa fa-chevron-up"></a>
            <a href="javascript:;" class="fa fa-times"></a>
        </span>
    ...
    <section class="panel">
        <header class="panel-heading">
            <strong><i class="fa fa-power-off"></i> &nbsp; <a href="<?php echo $this->url->get('index/logOut'); ?>" style="text-transform: capitalize">Sign Out</a></strong>
        <span class="tools pull-right">
            <a href="javascript:;" class="fa fa-chevron-up"></a>
            <a href="javascript:;" class="fa fa-times"></a>
        </span>
