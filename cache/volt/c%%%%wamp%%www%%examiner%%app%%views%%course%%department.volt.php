                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <div class="position-center">
                            <form class="form-horizontal" method="post" action="<?= $this->url->get('course/department') ?>" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <?php foreach ($faculty as $keys => $values) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <select id="e1" class="populate" required name="codename" style="width: 400px;">
                                        ...
                                        <?php foreach ($lecturer as $keys => $values) { ?>
                                            <option value="<?= $values['codename'] ?>"><?= ucwords($values['firstname']) ?> <?= ucwords($values['lastname']) ?></option>
                                        <?php } ?>
                                        </optgroup>
