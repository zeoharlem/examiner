        ...
        <section class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="col-lg-2">
                    ...
                    <option value=""> --- </option>
                    <?php foreach (range(1, 10) as $vars) { ?>
            ...
            <div class="form-group">
                <form method="post" class="form-horizontal" id="multipleTable" action="<?= $this->url->get('course/multipleTable') ?>">
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td style="border:1px solid #bbb"><select required class="form-control m-bot15" style="font-size:12px;" name="department[]" required>
                                <?php foreach ($departments as $keys => $values) { ?>
