    ...
    <div class="col-md-12">
        <section class="panel">
                    ...
                    <div class="panel-body">
                        <form method="post" action="<?= $this->url->get('generatematric/') ?>" class="form-horizontal" enctype="multipart/form-data">
                 ...
                 <button type="submit" class="btn btn-sm btn-danger"><strong>PRINT OUT</strong></button>
                         <table class="table">
                          <thead> 
                             ...
                             <tbody>
                             <?php foreach ($names as $keys => $values) { ?>
                                 <tr> 
                                     <th scope="row"><?= $keys + 1 ?></th> <td><?= Phalcon\Text::upper($values['names']) ?></td> <td><?= $number[$keys]['number'] ?></td>
                                 </tr> 
                             </tbody> 
                             <?php } ?>
                         </table>
