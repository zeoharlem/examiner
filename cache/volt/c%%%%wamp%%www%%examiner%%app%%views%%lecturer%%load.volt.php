...
<section id="main-content">
    ...
    <div class="col-sm-12">
    <?php if (empty($lecturerPacks)) { ?>
    <div class="alert alert-danger"><strong>No Assigned Courses or Registered Student(s)<a class="pull-right" href="<?= $this->url->get('lecturer/display') ?>"> Back to Display Lecturers</a></strong></div>
    <?php } else { ?>
                    <section class="panel">
                        ...
                        <form method="post" class="form-inline">
                            <table class="table table-striped" id="dynamic-table-straight">
                                ...
                                <tbody>
                                <?php foreach ($lecturerPacks as $keys => $values) { ?>
                                <tr>
                                    <td><?= $keys + 1 ?></td>
                                    <td><?= ucwords($values['fullname']) ?><br/><small><strong><i class="fa fa-phone"></i> &nbsp; <?= $values['phone'] ?></strong></small></td>
                                    <td><?= $values['matric'] ?></td>
