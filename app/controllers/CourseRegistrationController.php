...
class CourseregistrationController extends BaseController{
    ...
    public function initialize() {
        parent::initialize();
        \Phalcon\Tag::appendTitle('Registered Courses');
                    ...
                    $response->setJsonContent(array(
                        ...
                        'data'      => array(
                            'firstname' => Students::find('matric="'.
                                    $this->request->getPost('matric').'"')->getFirst()->othernames,
    ...
    private function __checkRegs($param){
        $courseRegs = Courseregistration::find($param)->getFirst();
        return !$courseRegs ? false : true;
    }
}
