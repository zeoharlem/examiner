        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="position-left">
                    <form class="form-inline" method="post" action="{{url('results/viewForm')}}" role="form">
                                ...
                                <tr>
                                    ...
                                    <td style="border:1px solid #ddd;">
                                        <div class="btn-row">
                                            ...
                                            <a href="{{url('results/viewAllLevel?matric='~values['matric'])}}" class="btn btn-default" style="font-size:13px;"><strong>All</strong></a>
                                        </div>    
                                    </td>
                                </tr>
                                {% endfor %}
