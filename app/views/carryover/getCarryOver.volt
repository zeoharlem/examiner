                        ...
                        <div class="panel-body">
                            ...
                            <table class="table table-striped table-bordered" id="dynamic-table-carry">
                                ...
                                <tr>
                                    ...
                                    <td>{{values['course'] | upper}}<input type="hidden" name="course[]" value="{{values['course']}}" /></td>
                            ...
                            <p></p>
                            <form id="fileuploader" action="{{url('results/uploadAjax')}}" method="POST" enctype="multipart/form-data">
