...
<html class="no-js" lang="en">
    ...
    <div class="brand">
        ...
        <a href="{{url('dashboard/?type=')}}" class="logo">
        ...
        <ul class="nav pull-right top-menu">
            ...
            <li class="dropdown">
                <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                    ...
                    <span class="username">{{session.get('auth')['username']}}</span>
                    <b class="caret"></b>
                </a>
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li class="active"><a href="{{url('course/multipleTable')}}">Course Multiple Table</a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li class="active"><a href="{{url('carryover/download')}}">Download CarryOver Courses</a></li>
                        <li><a href="{{url('carryover/')}}">Carry Over</a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{url('carryover/')}}">View Congregations</a></li>
                        <li><a href="{{url('congregation/add')}}">Add Congregation</a></li>
                        <li class="active"><a href="{{url('congregation/results')}}"><strong>Congregation Results</strong></a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a href="{{url('carryover/')}}">Upload Carry Over(s)</a></li>
                    </ul>
                </li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li class="active"><a href="{{url('lecturer/display')}}">View Lecturers</a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li class="active"><a href="{{url('course/faculty')}}">Faculty</a></li>
                        <li class="active"><a href="{{url('course/department')}}">Department</a></li>
                        <li class="active"><a href="{{url('course/programs')}}">Programs</a></li>
                    </ul>
                </li>
